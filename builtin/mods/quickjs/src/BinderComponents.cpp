...
ScriptComponentBinderComponent::ScriptComponentBinderComponent(ScriptApi::ScriptObjectHandle &&handle)
    : handle(handle) {}
ScriptComponentBinderComponent::~ScriptComponentBinderComponent() {}

// * ScriptEventDataBinderComponent
ScriptEventDataBinderComponent::ScriptEventDataBinderComponent(ScriptApi::ScriptObjectHandle &&handle)
    : handle(handle) {}
...
ScriptTickingAreaBinderComponent::ScriptTickingAreaBinderComponent(ScriptApi::ScriptObjectHandle &&handle)
    : handle(handle) {}
ScriptTickingAreaBinderComponent::~ScriptTickingAreaBinderComponent() {}

// * ScriptBlockPositionBinderComponent
ScriptBlockPositionBinderComponent::ScriptBlockPositionBinderComponent() {}
ScriptBlockPositionBinderComponent::ScriptBlockPositionBinderComponent(BlockPos const &pos)
    : pos(pos) {}
ScriptBlockPositionBinderComponent::~ScriptBlockPositionBinderComponent() {}
